"""
:mod:`grams -- NGram manipulation toolkit
========================================================================

.. moduleauthor:: Michel Albert (to version 2)
.. moduleauthor:: Graham Poulter (version 3+)
.. moduleauthor:: Mark Kennedy (refactor into new toolkit + weighted support)
...
class NGram:
   ...
   :type weights: [item,...]
   :param items: mapping of N-grams to weights (between 0.0 and 1.0) used for increased selectivity. Default weight in key '$$$'
   ...
   def __init__(self, weights=[], threshold=0.0, warp=1.0, iconv=None,
